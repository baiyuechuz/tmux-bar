...
RED=$(tmux_get @tmux_power_c0_red "#fca5a5")
GREEN=$(tmux_get @tmux_power_c0_green "#b5e8b0")
YELLOW=$(tmux_get @tmux_power_c0_yellow "#e8d4b0")
BLUE=$(tmux_get @tmux_power_c0_blue "#bae6fd")
PURPLE=$(tmux_get @tmux_power_c0_purple "#a5b4fc")
GRAY=$(tmux_get @tmux_power_c0_gray "#71798b")
BG=$(tmux_get @tmux_power_c0_bg "#182030")
BLOCK_BG=$(tmux_get @tmux_power_c0_block_bg "#323948")
FG=$(tmux_get @tmux_power_c0_fg "#e0e0e0")
